...
class PurchaseTransaction(OdooEntity):
    ...
    scheduled_date: Optional[datetime] = Field(serialization_alias="scheduled_date")
    ...
    estimate_total_amount: float = Field(serialization_alias="estimate_total_amount")
...
class PurchaseTransactionItem(OdooEntity):
    purchase_transaction_id: RelatedOdooEntity = Field(serialization_alias="purchase_transaction_id")
    ...
    estimate_total_price: float = Field(serialization_alias="estimate_total_price")
...
class PurchaseTransactionDetail(PurchaseTransaction):
    line_ids: Optional[list[PurchaseTransactionItem]] = Field(serialization_alias="line_ids")
